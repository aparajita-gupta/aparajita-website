// Synced from the Experience section of Aparajita_Resume(V8).pdf.
...
export const experience: Experience[] = [
  {
    ...
    points: [
      ...
      "Evaluated 5+ models (custom & ResNet-18 CNNs, KNN, SVM, Random Forest) to identify the optimal predictor.",
    ],
  },
  {
    org: "IEEE Racing",
    ...
    points: [
      ...
      "Coordinated with the mechanical team to streamline power distribution and telemetry integration for faster testing.",
  ...
  },
  {
    ...
    points: [
      ...
      "Worked in a 6-member Agile team with biweekly sprints, improving deliverable quality and communication.",
